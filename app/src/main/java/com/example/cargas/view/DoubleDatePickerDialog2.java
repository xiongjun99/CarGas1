 ...
 * </p>
 */
public class DoubleDatePickerDialog2 extends AlertDialog implements OnClickListener, OnDateChangedListener{
...
//		mTimePicker.setIs24HourView(true);
		mTimePicker.setOnTimeChangedListener(new OnTimeChangedListener() {
			...
			public void onTimeChanged(TimePicker view, int hourOfDay, int minute) {
				...
				Toast.makeText(ctx, hourOfDay+"时"+minute+"分", 0).show();
...
//	}
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		// which));
		// 锟斤拷锟斤拷恰锟饺� 锟斤拷锟斤拷锟斤拷钮锟斤拷锟津返回ｏ拷锟斤拷锟斤拷恰锟饺� 锟斤拷锟斤拷锟斤拷钮锟斤拷锟斤拷锟斤拷锟斤拷执锟斤拷
